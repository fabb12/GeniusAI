from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QFontComboBox)
from PyQt6.QtGui import QIcon, QAction, QTextListFormat, QTextCharFormat, QColor
from PyQt6.QtCore import pyqtSignal, Qt

from src.ui.CustomTextEdit import CustomTextEdit
from src.ui.CollapsibleToolBar import CollapsibleToolBar
...
class RichTextEditor(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.toolbar = CollapsibleToolBar(self)
    ...
    def _setup_toolbar(self):
        ...
        self.toolbar.addCollapsibleSection("Stile", [self.bold_action, self.italic_action, self.underline_action])

        # --- Font and Size ---
        self.font_combo = QFontComboBox(self)
        self.font_combo.currentFontChanged.connect(self.set_font_family)
        self.toolbar.addFontComboBox(self.font_combo)

        increase_font_action = QAction(QIcon(get_resource("8666578_arrow_up_circle_icon.png")), "Aumenta Dimensione", self)
        increase_font_action.setShortcut("Ctrl++")
        increase_font_action.triggered.connect(self.increase_font_size)

        decrease_font_action = QAction(QIcon(get_resource("8666700_sunset_icon.png")), "Diminuisci Dimensione", self)
        decrease_font_action.setShortcut("Ctrl+-")
        decrease_font_action.triggered.connect(self.decrease_font_size)

        self.toolbar.addCollapsibleSection("Font", [increase_font_action, decrease_font_action])

        # --- Clear Formatting ---
        clear_format_action = QAction(QIcon(get_resource("reset.png")), "Pulisci Formattazione", self)
        ...
        self.toolbar.addCollapsibleSection("Paragrafo", [bullet_action, numbered_action])
    ...
    def _update_toolbar_state(self):
        ...
        self.font_combo.setCurrentFont(self.text_edit.currentFont())
    ...
    def increase_font_size(self):
        ...
        self.text_edit.setFontPointSize(self.text_edit.fontPointSize() + 1)
    ...
    def clear_formatting(self):
        ...
        # You might want to set a default font and size
        # default_format.setFont(QFont("Arial", 12))

        # Reset other properties
        default_format.setFontWeight(400) # Normal weight
        default_format.setFontItalic(False)
        default_format.setFontUnderline(False)
        default_format.setBackground(QColor(Qt.GlobalColor.transparent)) # No background color
