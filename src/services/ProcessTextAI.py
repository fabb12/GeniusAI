...
from src.config import (
    ...
    PROMPT_COMBINED_ANALYSIS, PROMPT_COMBINED_SUMMARY_TEXT_ONLY, PROMPT_FILENAME_GENERATION
)
...
class ProcessTextAI(QThread):
    ...
    def __init__(self, mode, language, prompt_vars, parent=None):
        ...
        # Valida la modalità
        valid_modes = ["summary", "fix", "youtube_summary", "video_integration", "combined_summary", "combined_summary_text_only", "filename_generation"]
    ...
    def _process_text_with_selected_model(self):
        ...
        elif self.mode == "filename_generation":
            prompt_file_path = PROMPT_FILENAME_GENERATION
        else:
