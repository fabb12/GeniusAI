...
class VideoAudioManager(QMainWindow):
    ...
    def initUI(self):
        ...
        # PLAYER OUTPUT
        # ---------------------
        # Use a container with a QStackedLayout to ensure video renders correctly
        self.videoOutputContainer = QWidget()
        videoOutputStackLayout = QStackedLayout(self.videoOutputContainer)
        self.videoOutputContainer.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        ...
        videoOutputStackLayout.addWidget(self.videoOutputWidget)
        ...
        videoOutputLayout.addWidget(self.videoOutputContainer)
        ...
        videoPlayerLayout.addWidget(self.videoContainer) # Add the container with the stacked layout
